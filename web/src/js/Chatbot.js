...
DB Result (${totalRows} rows, sample of ${sampleData.length}):
${dataStr}

AGGREGATED STATS:
${aggStr}

${aggregated && aggregated.per_player ? "PER-PLAYER INDIVIDUAL STATS (MUST USE for comparisons):
" + JSON.stringify(aggregated.per_player, null, 2) : ""}
